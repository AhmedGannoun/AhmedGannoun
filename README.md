...
![myskills](https://go-skill-icons.vercel.app/api/icons?i=js,html,css,tailwindcss,materialui,bootstrap,react,redux,vite,npm,chartjs,php,mysql,firebase,mongodb,fastapi,expressjs,python,c,java,oracle,qt,postman,git,github,terminal,vscode,photoshop,illustrator,figma)
